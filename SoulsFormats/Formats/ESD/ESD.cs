...
namespace SoulsFormats.ESD
{
    ...
    {
        private static readonly Dictionary<ESDFormatType, string> ESDMagicByFormat = new Dictionary<ESDFormatType, string>
        {
            [ESDFormatType.LittleEndian32Bit] = "fSSL",
            [ESDFormatType.LittleEndian64Bit] = "fsSL",
            [ESDFormatType.BigEndian64Bit] = "FsSL",
            [ESDFormatType.BigEndian32Bit] = "FSSL",
            //[ESDFormatType.DemonsSoulsLegacy] = "DLSE",
        };

        private static Dictionary<string, ESDFormatType> ESDFormatByMagic => ESDMagicByFormat.ToDictionary(kvp => kvp.Value, kvp => kvp.Key);

        /// <summary>
        /// The format type of this ESD.
        /// </summary>
        public ESDFormatType FormatType;

        private bool LongFormat => 
            FormatType == ESDFormatType.LittleEndian64Bit || 
            FormatType == ESDFormatType.BigEndian64Bit;
        ...
        /// </summary>
        public int Unk6C, Unk70, Unk74, Unk78, Unk7C;
        ...
        /// </summary>
        public ESD() : this(ESDFormatType.LittleEndian32Bit, 1) { }
        ...
        internal override bool Is(BinaryReaderEx br)
        {
            ...
            return ESDFormatByMagic.ContainsKey(magic);
        }

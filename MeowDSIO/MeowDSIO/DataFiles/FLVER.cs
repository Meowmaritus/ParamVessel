...
namespace MeowDSIO.DataFiles
{
    public class FLVER : DataFile
    {
        ...
        protected override void Write(DSBinaryWriter bin, IProgress<(int, int)> prog)
        {
            ...
            bin.Placeholder32("DataOffset");
            bin.Placeholder32("DataSize");
            ...
            for (int i = 0; i < LIST_materials.Count; i++)
            {
                ...
                bin.Placeholder32($"Materials[{i}].Name");
                bin.Placeholder32($"Materials[{i}].MTDName");
            ...
            for (int i = 0; i < Bones.Count; i++)
            {
                ...
                bin.Placeholder32($"Bones[{i}].Name");
            ...
            for (int i = 0; i < Submeshes.Count; i++)
            {
                ...
                bin.Placeholder32($"Submeshes[{i}].BoneIndicesOffset");

                bin.Write(mesh.FaceSets.Count);
                bin.Placeholder32($"Submeshes[{i}].FaceSetIndicesOffset");

                bin.Write(mesh.VertexGroups.Count);
                bin.Placeholder32($"Submeshes[{i}].VertexGroupIndicesOffset");
            ...
            for (int i = 0; i < LIST_faceSets.Count; i++)
            {
                ...
                bin.Placeholder32($"FaceSets[{i}].VertexIndicesOffset");
            ...
            for (int i = 0; i < LIST_vertexGroups.Count; i++)
            {
                ...
                bin.Placeholder32($"VertexGroups[{i}].VertexBufferOffset");
            }
            ...
            for (int i = 0; i < VertexStructLayouts.Count; i++)
            {
                ...
                bin.Placeholder32($"VertexStructLayouts[{i}].MembersOffset");
            }
            ...
            for (int i = 0; i < LIST_materialParameter.Count; i++)
            {
                ...
                bin.Placeholder32($"MaterialParameters[{i}].Value");
                bin.Placeholder32($"MaterialParameters[{i}].Name");
            ...
            for (int i = 0; i < VertexStructLayouts.Count; i++)
            {
                ...
                bin.Replace32($"VertexStructLayouts[{i}].MembersOffset", (int)bin.Position);
            ...
            for (int i = 0; i < Submeshes.Count; i++)
            {
                ...
                bin.Replace32($"Submeshes[{i}].BoneIndicesOffset", (int)bin.Position);
            ...
            for (int i = 0; i < Submeshes.Count; i++)
            {
                ...
                bin.Replace32($"Submeshes[{i}].FaceSetIndicesOffset", (int)bin.Position);
            ...
            for (int i = 0; i < Submeshes.Count; i++)
            {
                ...
                bin.Replace32($"Submeshes[{i}].VertexGroupIndicesOffset", (int)bin.Position);
            ...
            for (int i = 0; i < LIST_materials.Count; i++)
            {
                ...
                bin.Replace32($"Materials[{i}].Name", (int)bin.Position);
                bin.WriteStringUnicode(mat.Name, terminate: true);

                bin.Replace32($"Materials[{i}].MTDName", (int)bin.Position);
                ...
                foreach (var index in matInfo.MaterialParameterIndices)
                {
                    ...
                    bin.Replace32($"MaterialParameters[{index}].Value", (int)bin.Position);
                    bin.WriteStringUnicode(mp.Value, terminate: true);

                    bin.Replace32($"MaterialParameters[{index}].Name", (int)bin.Position);
            ...
            for (int i = 0; i < Bones.Count; i++)
            {
                ...
                bin.Replace32($"Bones[{i}].Name", (int)bin.Position);
            ...
            bin.Replace32("DataOffset", (int)LOC_Data);
            ...
            for (int i = 0; i < Submeshes.Count; i++)
            {
                ...
                foreach (var faceSetIndex in meshInfo.FaceSetIndices)
                {
                    ...
                    bin.Replace32($"FaceSets[{faceSetIndex}].VertexIndicesOffset", (int)(bin.Position - LOC_Data));
                ...
                foreach (var vertexGroupIndex in meshInfo.VertexGroupIndices)
                {
                    ...
                    bin.Replace32($"VertexGroups[{vertexGroupIndex}].VertexBufferOffset", (int)(bin.Position - LOC_Data));
                    for (int j = 0; j < vertexGroup.VertexCount; j++)
                    {
            ...
            bin.Replace32("DataSize", dataSize);
        }
